        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mb-8 flex flex-col md:flex-row md:justify-between md:items-center gap-4">
            <div className="flex items-center gap-4">
              <button
                onClick={() => navigate('/pineapple')}
                className="rounded-full bg-white shadow-md border-0 px-4 py-2 flex items-center text-green-700 font-semibold hover:bg-green-50 transition-all text-base"
              >
                <FaArrowLeft className="mr-2" /> Quay lại
              </button>
              <h1 className="text-3xl font-extrabold text-green-700 drop-shadow-sm tracking-wide">{crop.name}</h1>
            </div>
            <div className="flex gap-3">
              <button
                onClick={() => navigate(`/pineapple/${id}/edit`)}
                className="rounded-full bg-gradient-to-r from-green-500 to-lime-400 text-white shadow-md px-6 py-2 font-semibold text-base hover:scale-105 transition-all"
              >
                <FaEdit className="mr-2" /> Chỉnh sửa
              </button>
              <button
                onClick={() => setShowDeleteModal(true)}
                className="rounded-full bg-gradient-to-r from-red-400 to-orange-300 text-white shadow-md px-6 py-2 font-semibold text-base hover:scale-105 transition-all"
              >
          ...
          {/* Tabs */}
          <div className="mb-8 border-b-2 border-green-100">
            <nav className="flex gap-8">
              <button
                onClick={() => setActiveTab('overview')}
                className={`py-4 px-1 border-b-4 font-bold text-lg transition-all duration-200 ${
                  activeTab === 'overview'
                    ? 'border-green-500 text-green-700 bg-green-50 rounded-t-2xl shadow'
          ...
          {/* Nội dung tab */}
          <div className="rounded-3xl shadow-2xl bg-white p-8 mb-8 animate-fadeIn">
            {activeTab === 'overview' && (
