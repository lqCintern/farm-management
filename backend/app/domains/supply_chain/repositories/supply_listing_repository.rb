  ...
  module Repositories
    class SupplyListingRepository      
      ...
      def find_all(filters = {}, page = 1, per_page = 15)
        query = ::SupplyChain::SupplyListing.where(status: :active)
      ...
      def create(entity)
        record = ::SupplyChain::SupplyListing.new(
          name: entity.name,
      ...
      def update(id, attributes)
        record = ::SupplyChain::SupplyListing.find_by(id: id)
      ...
      def find_similar(id, limit = 6)
        ...
        similar_records = ::SupplyChain::SupplyListing.where(category: record.category)
      ...
      def find_by_user_id(user_id)
        records = ::SupplyChain::SupplyListing.where(user_id: user_id)
      ...
      def find_by_id_and_user(id, user_id)
        record = ::SupplyChain::SupplyListing.includes(supply_images: { image_attachment: :blob })
