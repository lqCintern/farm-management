module Farming
  module Services
    ...
    def update_pineapple_crop_if_needed
      ...
      pineapple_crop = ::Farming::PineappleCrop.find_by(id: @farm_activity.crop_animal_id)
    ...
    def update_pineapple_crop_after_completion
      ...
      remaining_activities = ::Farming::FarmActivity.where(
    ...
    def check_stage_completion
      ...
      crop = ::Farming::PineappleCrop.find_by(id: @farm_activity.crop_animal_id)
