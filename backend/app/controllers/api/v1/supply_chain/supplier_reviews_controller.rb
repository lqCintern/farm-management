  ...
  module V1
    module SupplyChain
      class SupplierReviewsController < BaseController
        ...
        def create
          result = CleanArch.create_supplier_review.execute(
        ...
        def supplier_reviews
          ...
          reviews_result = CleanArch.list_supplier_reviews.execute(
            params[:id],
            params[:page] || 1,
            params[:per_page] || 10
          )
          ...
          stats_result = CleanArch.get_supplier_rating_stats.execute(params[:id])
