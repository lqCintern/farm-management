  ...
  module Farming
    class FieldRepository
      ...
      def find_all(user_id, filters = {})
        query = ::Models::Farming::Field.where(user_id: user_id)
      ...
      def create(attributes, user_id)
        record = ::Models::Farming::Field.new(attributes)
      ...
      def update(id, attributes, user_id)
        record = ::Models::Farming::Field.where(user_id: user_id).find_by(id: id)
      ...
      def find_activities(id, user_id)
        field = ::Models::Farming::Field.where(user_id: user_id).find_by(id: id)
      ...
      def get_statistics(user_id)
        ...
        total_area = ::Models::Farming::Field.where(user_id: user_id).sum(:area)
