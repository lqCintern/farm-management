class PineappleCrop < ApplicationRecord
  # Relationships
  belongs_to :user
  ...
  def advance_to_next_stage
    ...
    current_index = PineappleCrop.current_stages[current_stage]
    next_stage = PineappleCrop.current_stages.key(current_index + 1)
