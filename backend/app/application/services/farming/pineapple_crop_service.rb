module Services::Farming
  class PineappleCropService
    ...
    def record_harvest(quantity)
      ...
      harvest = ::Models::Farming::Harvest.new(
        user_id: @user.id,
    ...
    def preview_plan(crop_params)
      ...
      stages.each do |stage|
        ...
        templates.each do |template|
          ...
          activities << ::Farming::FarmActivity.new(
    ...
    def create_activities_from_templates
      ::Farming::PineappleCrop.current_stages.keys.each do |stage|
    ...
    def get_templates_for_stage(stage, crop = nil)
      crop ||= @pineapple_crop
      user_templates = ::Models::Farming::PineappleActivityTemplate.where(user_id: @user.id, stage: stage)
