  ...
  module LaborAssignments
    class UpdateAssignmentStatus
      ...
      def execute(assignment_entity, status, params, current_user)
        ...
        labor_request = ::Models::Labor::LaborRequest.find_by(id: assignment_entity.labor_request_id)
        ...
        when :completed
          ...
          requesting_household = ::Models::Labor::FarmHousehold.find_by(id: labor_request.requesting_household_id)
        ...
        if updated_assignment
          ...
          if status.to_sym == :completed && [ "exchange", "mixed" ].include?(labor_request.request_type)
            ...
            labor_exchange = ::Models::Labor::LaborExchange.find_or_create_between(
