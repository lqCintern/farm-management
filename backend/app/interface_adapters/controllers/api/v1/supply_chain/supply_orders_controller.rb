  ...
  module V1
    module SupplyChain
      class SupplyOrdersController < BaseController
        ...
        def index
          result = Services::CleanArch.supplier_list_orders.execute(
        ...
        def show
          result = Services::CleanArch.supplier_get_order_details.execute(params[:id])
        ...
        def update
          result = Services::CleanArch.supplier_update_order_status.execute(
            params[:id],
            params[:status],
        ...
        def dashboard
          result = Services::CleanArch.supplier_get_dashboard.execute(current_user.user_id)
