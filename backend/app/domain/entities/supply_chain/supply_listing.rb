  ...
  module SupplyChain
    class SupplyListing
      attr_accessor :id, :name, :description, :category, :price, :unit, :quantity,
                   ...
                   :images, :supplier, :similar_listings, :order_count, :last_updated
      ...
      def validate
        ...
        # Chuyển đổi price thành số trước khi validate
        price_value = price.to_f if price.present?
        errors << "Giá phải lớn hơn 0" if price_value.nil? || price_value <= 0
