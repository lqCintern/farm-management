  ...
  class ProductOrderService
    ...
    def update_status(status, reason = nil)
      ...
      when "accept"
        ...
        return { success: true, message: "Đã chấp nhận đơn hàng", status: @order.status }
      ...
      when "reject"
        ...
        return { success: true, message: "Đã từ chối đơn hàng", status: @order.status }
      ...
      when "complete"
        ...
        return { success: true, message: "Đã hoàn thành đơn hàng", status: @order.status }
      else
